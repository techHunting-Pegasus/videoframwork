...
#ifndef CUSTOMVIDEOPLYER_SWIFT_H
#define CUSTOMVIDEOPLYER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="CustomVideoplyer",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class UITouch;
SWIFT_CLASS("_TtC16CustomVideoplyer21CustomVideoPlayerView")
@interface CustomVideoPlayerView : UIView <UIGestureRecognizerDelegate>
