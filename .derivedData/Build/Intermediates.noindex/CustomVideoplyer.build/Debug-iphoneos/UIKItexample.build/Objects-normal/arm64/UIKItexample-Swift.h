...
#ifndef UIKITEXAMPLE_SWIFT_H
#define UIKITEXAMPLE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="UIKItexample",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC12UIKItexample11AppDelegate")
...
@class UIWindow;
@class UIScene;
SWIFT_CLASS("_TtC12UIKItexample13SceneDelegate")
...
@class NSBundle;
@class NSCoder;
SWIFT_CLASS("_TtC12UIKItexample14ViewController")
